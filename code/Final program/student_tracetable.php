...
?>
                   <div style='text-align:left' class='notice'>*Notice:<br>- This file only has <?php echo sizeof($result_s) ?> statements. <br>- You only need to fill in statements included equation. <br>- If there is a loop, statemnts should end at the condition line.</div>
