    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 pt-3">
            <div style="text-align:center"><h1>Welcome, <?php echo $username ?> &nbsp;!</h1></div>
          ...
          <div style="text-align:center">
           <input type="submit" onClick="window.location.href='student_selectcode.php'" class="btn btn-info" value="Go to code selection" />
         </div>
