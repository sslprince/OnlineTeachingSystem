...
<?php
    ...
    else
    {
        ...
        for($i=1;$i<sizeof($code);$i++)                    //how many columns
        {
          ...
          $query = "replace INTO studentlist(username,class,keyvalue)VALUES('$username','$class','$key')";
          $res = $db->insert($query);
          $query1 = "SELECT clientlist.name, clientlist.username, studentlist.class FROM clientlist inner join studentlist on '$username'=clientlist.username";
